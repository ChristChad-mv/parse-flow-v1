...
export function FlowToExecutionPlan(nodes: AppNode[], edges: Edge[]): FlowToExecutionPlanType {
  ...
  for(let phase = 1; phase < nodes.length && planned.size; phase++) {
